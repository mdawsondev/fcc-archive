...
function init() {
  ...
  (0, _jquery2.default)('#total').click(function () {
    calculator.calculate();
  });
  (0, _jquery2.default)('#ac').click(function () {
    calculator.reset(true);
  });
  (0, _jquery2.default)('#ce').click(function () {
    calculator.clearEntry();
  });
  (0, _jquery2.default)('#ans').click(function () {
    calculator.answer();
  });
}
...
var Calculator = function () {
  ...
  _createClass(Calculator, [{
    ...
    key: 'buildOutput',
    value: function buildOutput(btn) {
      this.output += btn;
      this.outputPretty = this.output.replace(/\*/g, '&times;').replace(/\-/g, '&minus;').replace(/\//g, '&divide;');
      (0, _jquery2.default)('#output').html(this.outputPretty);
    }
  }, {
    key: 'buildHistory',
    ...
    value: function calculate() {
      ...
      (0, _jquery2.default)('#output').html('0');
      this.buildHistory();
    }
  }, {
    key: 'clearEntry',
    ...
    key: 'outputHistory',
    value: function outputHistory() {
      (0, _jquery2.default)('#history').html(this.historyDisplay);
    }
  }, {
    key: 'reset',
    value: function reset(isCls) {
      if (isCls) {
        this.history = [];
        this.historyDisplay = '';
        this.output = 0;
      ...
      this.result = 0;
      (0, _jquery2.default)('#output').text(this.output);
      (0, _jquery2.default)('#history').html(this.historyDisplay);
    }
  }]);
